...
import com.myweather.app.util.PermissionHelper;
...
public class SplashActivity extends BaseActivity {
	...
	private void runApp() {
		//初始化SDK
		AdManager.getInstance(mContext).init("9ef50b31516dc2fb", "06ab42da676afeaf", true);
		//设置开屏
		setupSplashAd();
	}
	...
	private void setupSplashAd() {
		...
		// 设置跳转的窗口类
		splashViewSettings.setTargetClass(ChooseAreaActivity.class);
		// 设置开屏的容器
